...
\begin{align*}
 \text{while  } &f(\v{x}_k + \alpha_k\v{d}_k) > \tau\alpha_k\nabla f(\v{x}_k)^{\top}\v{d}_k \text{  do}\\
...
\begin{align*}
 min \hspace{15pt} &r^2 \\
 s.t. \hspace{15pt} &(x - x_i)^2 + (y - y_i) \leq r^2,\,i = 1, ..., n \\
 &r \geq 0
\end{align*}
...
\begin{align*}
 ...
 &+ \sum_{i = 1}^{n}max\{0, x_i^2 + y_i^2 - (r - r_i)^2\} \\
